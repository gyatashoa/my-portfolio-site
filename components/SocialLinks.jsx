                ...
                links.map((link,index)=>(
                        <div key={index} className="hover:animate-bounce h-10 w-10">
                            <Link href={link.link}><a target="_blank">
                                <Image src={link.img} alt="link" height="30px" width="30px"/>
                                </a></Link>
                        </div>
                ))
            }
